...
// public AlignToReefTagRelative(boolean isRightScore, CommandSwerveDrivetrain
// drivebase) {
// xController = new PIDController(Constants.AutoAlign.X_REEF_ALIGNMENT_P, 0.0,
// 0); // Vertical movement
// yController = new PIDController(Constants.AutoAlign.Y_REEF_ALIGNMENT_P, 0.0,
// 0); // Horitontal movement
// rotController = new PIDController(Constants.AutoAlign.ROT_REEF_ALIGNMENT_P,
// 0, 0); // Rotation
...
// // Requires the robot to stay in the correct position for 0.3 seconds, as
// long
// // as it gets a tag in the camera
// return
// this.dontSeeTagTimer.hasElapsed(Constants.AutoAlign.DONT_SEE_TAG_WAIT_TIME)
// ||
